...
**Изучено в модуле «Математический аппарат физики»:** [[Physics/Физическая величина|физическая величина]], [[Physics/Размерность физической величины|размерность]], [[Physics/Единицы измерения и система SI|SI]], [[Physics/Скалярные и векторные величины|скаляры и векторы]], [[Physics/Координатная система и компоненты вектора|координаты и компоненты]], [[Physics/Изменение величины и символ дельта|конечное изменение]], [[Physics/Производная как скорость изменения|производная]], [[Physics/Интеграл как накопление|интеграл]], [[Physics/Дифференциальное уравнение|дифференциальное уравнение]] и [[Physics/Численное накопление состояния|численное накопление]].

**Повторение формул:** [[Physics/Формулы — математический аппарат физики|карточка формул Module 0]].

**Требует повторения:** смысл производной, различие `Δ` и `d`, интеграл как накопление, связь производной и интеграла, начальные условия и переход от математической модели к коду.

**Следующий шаг:** исследовать связь `x(t)`, `v(t)` и `a(t)` через дискретное суммирование и метод Эйлера в Python.
