...
[[Supervisor]] выбирает исполнителя, [[Multi-Agent]] система делит работу между агентами, а [[Multi-Agent, Supervisor и Subgraph|Subgraph]] прячет сложный workflow за одним узлом.
