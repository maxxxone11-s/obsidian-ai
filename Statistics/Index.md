...
Область для статистического фундамента Machine Learning, подготовки признаков и понятий, которые нужны для понимания [[Transformers/LayerNorm|LayerNorm]] и ML preprocessing.
...
1. [[Mean]]
2. [[Variance]]
3. [[Причина использования квадратов в статистике]]
