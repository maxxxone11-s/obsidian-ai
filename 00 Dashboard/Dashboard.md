...
### Навигация
- [[01 Roadmap/Roadmap|🗺️ Дорожная карта обучения]]
- [[02 Progress/Learning Log|📊 Журнал прогресса]]
- [[Indexes/Index|📑 Полный индекс]]
...
- [[Templates/Review Template|🔍 Шаблон для проверки]]
- [[Templates/Sync Package|📦 Синхронизация из ChatGPT]]
...
- **2026-07-22** — Создана отдельная учебная карточка формул математического аппарата физики
- **2026-07-22** — Синхронизация Physics: физические величины, SI, размерность, векторы, производная, интеграл, дифференциальные уравнения и численное накопление
